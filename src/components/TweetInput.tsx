...
const TweetInput: React.FC = () => {
  ...
  const sendTweet = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if(tweetImage){
      ...
      uploadTweetImg.on(firebase.storage.TaskEvent.STATE_CHANGED,
        ()=>{},
        (err:any)=>{throw new Error(err.message);},
        async ()=>{
    ...
    <>
      <form onSubmit={sendTweet}>
        ...
        <Button
          type='submit'
          disabled={!tweetMsg}
          className={tweetMsg ? styles.tweet_sendButton : styles.tweet_sendDisabledButton}
        >
          Tweet
        </Button>
      </form>
